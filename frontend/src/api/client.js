...
export const devicesApi = {
  ...
  refreshL2:           (id)       => api.post(`/devices/${id}/l2/refresh`, null, { timeout: 10000 }),
  getL2RefreshStatus:  (id, jobId) => api.get(`/devices/${id}/l2/refresh/${jobId}/status`),
...
export const systemSettingsApi = {
  ...
  testAlert: () => api.post('/system-settings/test-alert'),
}
